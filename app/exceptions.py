...
class FileValidationError(OCRLoadException):
    ...
    def __init__(self, message: str, details: dict[str, Any] | None = None):
        super().__init__(
            message=message, error_code="FILE_VALIDATION_ERROR", details=details
        )
...
class DownloadError(OCRLoadException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="DOWNLOAD_ERROR", details=details)
...
class OCRError(OCRLoadException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="OCR_ERROR", details=details)
...
class OCRTimeoutError(OCRError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, provider=provider, retry_recommended=True, details=details
        )
...
class OCRAuthenticationError(OCRError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, provider=provider, retry_recommended=False, details=details
        )
...
class DocumentParsingError(OCRLoadException):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, error_code="DOCUMENT_PARSING_ERROR", details=details
        )
...
def to_http_exception(
    exc: OCRLoadException, request_id: str | None = None
) -> HTTPException:
