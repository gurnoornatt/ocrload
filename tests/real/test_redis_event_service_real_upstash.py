"""Real integration test for Redis Event Service with Upstash REST API."""
...
os.environ['REDIS_URL'] = 'https://picked-bat-43341.upstash.io'
os.environ['REDIS_TOKEN'] = 'AalNAAIjcDE0MDU1MTVkOWEwMjQ0Mjc0OGNlYjk3Mjk2N2E5ZDQ1NnAxMA'

from app.services.redis_event_service import RedisEventService


class TestRedisEventServiceRealUpstash:
...
async def manual_test():
    ...
    for i in range(3):
        success = await service.emit_invoice_ready(f"batch_load_{i}", f"batch_driver_{i}")
