...
class TestParseTestRequest:
    ...
    def test_directory_traversal_prevention(self):
        ...
        for malicious_path in malicious_paths:
            ...
            assert any("Directory traversal not allowed" in str(error.get('msg', '')) or 
                      "Invalid file path" in str(error.get('msg', '')) 
    ...
    def test_invalid_path_format(self):
        ...
        for invalid_path in invalid_paths:
            if invalid_path is None:
                ...
                error_details = exc_info.value.errors()
                assert any("Path cannot be empty" in str(error.get('msg', '')) or 
                          "Invalid file path" in str(error.get('msg', '')) 
                          for error in error_details)
