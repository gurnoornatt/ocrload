...
class TestParsedDataModels:
    ...
    def test_coi_data_currency_parsing(self):
        ...
        coi = COIData(
            general_liability_amount="$1,000,000", auto_liability_amount="$500,000"
        )
...
class TestDatabaseModels:
    ...
    def test_document_requires_association(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            Document(type=DocumentType.CDL, url="https://storage.example.com/doc.jpg")
...
class TestRequestResponseModels:
    ...
    def test_document_create_request(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DocumentCreateRequest(
                doc_type=DocumentType.CDL, media_url="https://example.com/media.jpg"
            )
